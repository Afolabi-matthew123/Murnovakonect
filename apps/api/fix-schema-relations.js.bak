...
schema = schema.replace(
  '  staffProfile       Staff?     @relation(fields: [teacherId], references: [staffNo])',
  '  staffProfile       Staff?     @relation("UserStaff", fields: [teacherId], references: [staffNo])'
);
...
console.log("â€¢ User â†’ Staff: via teacherId â†’ staffNo");
